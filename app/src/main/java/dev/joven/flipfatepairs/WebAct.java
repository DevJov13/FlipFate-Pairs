...
public class WebAct extends Activity {
    ...
    private void setSetting() {
        ...
        webView.setWebChromeClient(new WebChromeClient() {
            ...
            public void openFileChooser(ValueCallback<Uri> uploadMsg, String acceptType) {
                WebAct.this.mUploadCallBack = uploadMsg;
                openFileChooseProcess();
            }

            // For Android < 3.0
            public void openFileChooser(ValueCallback<Uri> uploadMsgs) {
                WebAct.this.mUploadCallBack = uploadMsgs;
                openFileChooseProcess();
            }
            ...
            public boolean onShowFileChooser(WebView webView,
                ...
                WebAct.this.mUploadCallBackAboveL = filePathCallback;
                openFileChooseProcess();
                return true;
            }
        });
    ...
    public class JsInterface {
        ...
        public void postMessage(String name, String data) {
            ...
            AppsFlyerLibUtility.event(WebAct.this, name, data);
        }
    }
