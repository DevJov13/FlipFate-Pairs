...
public class Policy_Activity extends AppCompatActivity {
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                String WgPackage = "javascript:window.WgPackage = {name:'" + getPackageName() + "', version:'"
                        + getAppVersionName(Policy_Activity.this) + "'}";
    ...
    private void setSetting() {
        ...
        webView.setWebChromeClient(new WebChromeClient() {
            ...
            public boolean onShowFileChooser(WebView webView,
                ...
                Policy_Activity.this.mUploadCallBackAboveL = filePathCallback;
    ...
    public class JsInterface {
        ...
        public void postMessage(String name, String data) {
            ...
            AppsFlyerLibUtility.event(Policy_Activity.this, name, data);
        }
    }
